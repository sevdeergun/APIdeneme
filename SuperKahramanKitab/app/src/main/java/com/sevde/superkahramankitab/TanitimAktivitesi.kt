...
import com.sevde.superkahramankitab.databinding.ActivityTanitimAktivitesiBinding
...
class TanitimAktivitesi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val secilenKahramanadapterdenGelenIntent.getSerializableExtra("secilenKahraman", SuperKahraman::class.java) //güncellemeden dolayı çalışmıyor

        val secilenKahraman = adapterdenGelenIntent.getSerializableExtra("secilenKahraman") as SuperKahramanSinifi
